...
for i=1:18
    ...
    %Image_first
    imageTexture = Screen('MakeTexture', window, practice_without__lable{i});
    ...
    %buy not buy image
    imageTexture1 = Screen('MakeTexture', window,practice_without__lable{i});
